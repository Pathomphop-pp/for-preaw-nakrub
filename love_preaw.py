...
st.markdown(
    ...
    <div style="text-align: center;">
        <iframe width="320" height="180" src="https://www.youtube.com/embed/21x4YgdwYD8?autoplay=1&loop=1&playlist=21x4YgdwYD8"
...
st.progress((365 - days_left_birthday) / 365)  # bar ความใกล้วันเกิด
####################################################################################################
# ========================
...
sender = st.selectbox("ใครกำลังส่งข้อความงับ?", [MY_NAME, PARTNER_NAME])

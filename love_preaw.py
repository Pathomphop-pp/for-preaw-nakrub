...
# ข้อความรัก
love_messages = [
    "วันนี้เราทำงานบ้านนะครับ",
    "กินข้างรึยังวันนี้อย่าลืมกินข้าวนะ",
    ...
    "https://www.youtube.com/watch?v=UQItWbZAvqU&list=RDUQItWbZAvqU&start_radio=1"
]
